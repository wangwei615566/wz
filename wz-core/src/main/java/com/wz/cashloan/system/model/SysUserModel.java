package com.wz.cashloan.system.model;

import org.springframework.beans.BeanUtils;

import com.wz.cashloan.core.common.exception.OperatorException;
import com.wz.cashloan.core.common.util.MD5;
import com.wz.cashloan.core.common.util.ValidateUtil;
...
public class SysUserModel extends SysUser {
	...
	public String validModifyPwdModel(SysUser user) {
		...
		} else if (!MD5.md5(getOldPassword()).equals(user.getPassword())) {
