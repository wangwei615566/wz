...
public class JsonUtil extends tool.util.JsonUtil {
	...
	private static ObjectMapper mapperNoFormatDate = new ObjectMapper();
	...
	public static void writeNoFormatDate(Writer writer,Object o){
		try {
			mapperNoFormatDate.writeValue(writer,o);
		} 
		catch (Exception e) {
			throw new IllegalStateException(e);
		} 
