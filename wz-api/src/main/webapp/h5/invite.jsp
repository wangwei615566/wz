    ...
    <div class="signup seven">                          
        ...
        <div class="content">
            <form action="/api/user/wxRegister.htm">
                <input name="phone" type="tel" value="" maxlength="11" placeholder="请输入手机号"/>
                ...
                <input id='invitation' name="invitationCode" type="text" value="<%=invitationCode%>" disabled="true" placeholder="推荐人"/>
                <%} %>
                 <%if(channelCode != null&&!channelCode.equals("")&&!channelCode.equals("null")){ %>
                <input id='channelCode' name="channelCode" type="hidden" value="<%=channelCode%>" />
                <%} %>
