...
<body>
    ...
    <div class="signup seven">                          
        <img class="bar" alt="" src="<%=basePath%>static/images/bonus.jpg"/>          
        <div class="content1">
        	<p class="ftitle"><a href="https://itunes.apple.com/us/app/id1289530994"><img class="bar" alt="" src="<%=basePath%>static/images/btn1.png"/></a></p>
            <p class="ftitle"><a href="http://www.czwxian.com/apk/release/czqb.apk"><img class="bar" alt="" src="<%=basePath%>static/images/btn2.png"/></a></p>
