...
<body>
    <img src="/static/images/logo_share.png" alt="" style="position:absolute;opacity: 0;left:-10000px;z-index: -1000;">
    <link rel="stylesheet" href="/static/css/style.css">
<div class="reg-agreement">
  <div class="reg-wrap">
    <h1>用户注册协议</h1>
    <p>郑重提示，本文系您与“成长钱包”（以下简称平台）之间的法律协议，请您认 真阅读并理解本协议。您通过平台点击确认本协议的，即表示您同意遵循本协议的所有约定，本协议在您和平台之间具有法律约束力。如发生法律纠纷，您不得以未仔细阅读或理解本协议为由进行抗辩。
    </p>
    <h2>第一条  用户确认及服务接纳</h2>
    <p>1.1 注册用户需满足下列条件：</p>
